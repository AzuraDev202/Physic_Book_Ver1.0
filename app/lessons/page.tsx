  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-80 z-40 group">
        ...
        {/* Actual sidebar */}
        <div className={`h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-all duration-300 ${sidebarOpen ? 'translate-x-0 shadow-xl' : '-translate-x-72 group-hover:translate-x-0 group-hover:shadow-xl'
          }`}>
          <div className="p-6">
            ...
            {lessons.map((lesson) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className={`px-4 py-2 rounded-lg font-medium transition-colors ${isLessonCompleted(lesson.id)
